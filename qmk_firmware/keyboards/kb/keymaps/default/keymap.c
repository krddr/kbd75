...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
   KEYMAP(
      LT(1, KC_ESC), KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_PSCR, KC_SLCK, KC_DEL,
   ...
   KEYMAP(
      ...
      KC_GRV, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MUTE,
   ...
   KEYMAP(
      ...
      KC_TRNS, MO(2), RGB_MOD, RGB_TOG, RGB_TOG, RGB_TOG, RGB_VAD, KC_TRNS, RGB_VAI, RGB_HUD, RGB_SAD, RGB_HUI),
